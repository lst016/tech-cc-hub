...
import { downloadFileFromPath } from '@/ui/aionui/utils/file/download';
import type { IDirOrFile } from '@/common/adapter/ipcBridge';
import type { PreviewContentType } from '@/common/types/preview';
import { emitter } from '@/ui/aionui/utils/emitter';
import {
  LARGE_TEXT_PREVIEW_MAX_LENGTH,
  LARGE_TEXT_PREVIEW_THRESHOLD,
} from '@/ui/aionui/pages/conversation/Preview/constants';
import { removeWorkspaceEntry, renameWorkspaceEntry } from '@/ui/aionui/utils/file/workspaceFs';
import { useCallback } from 'react';
import type { MessageApi, RenameModalState, DeleteModalState } from '../types';
import type { FileOrFolderItem } from '@/ui/aionui/utils/file/fileTypes';
