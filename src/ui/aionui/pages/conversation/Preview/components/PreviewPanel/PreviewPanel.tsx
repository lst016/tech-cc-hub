...
import { downloadFileFromPath, downloadTextContent } from '@/ui/aionui/utils/file/download';
import { useLayoutContext } from '@/ui/aionui/hooks/context/LayoutContext';
import { PreviewToolbarExtrasProvider, type PreviewToolbarExtras } from '../../context/PreviewToolbarExtrasContext';
import { usePreviewContext } from '../../context/PreviewContext';
import { useResizableSplit } from '@/ui/aionui/hooks/ui/useResizableSplit';
...
const PreviewPanel: React.FC = () => {
  ...
  const fallbackActiveTab = activeTab ?? {
    content: '',
    contentType: 'code' as const,
    metadata: undefined,
  };
  const { content, contentType, metadata } = fallbackActiveTab;
