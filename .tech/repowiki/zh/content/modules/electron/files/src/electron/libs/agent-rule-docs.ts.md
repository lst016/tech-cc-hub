# src/electron/libs/agent-rule-docs.ts

> 模块：`electron` · 语言：`typescript` · 行数：120
...
- `safeReadText@13`
- `buildSystemDefaultMarkdown@21`
- `loadAgentRuleDocuments@101`
- `saveUserAgentRuleDocument@113`
- `USER_AGENTS_FILE@11`
- `profiles@23`
- `builtinRequirement@24`
- `sections@68`
- `userClaudeRoot@103`
- `userAgentsPath@104`
- `userClaudeRoot@115`
- `userAgentsPath@116`
- `AgentRuleDocuments@4`
...
- `AgentRuleDocuments`
- `loadAgentRuleDocuments`
- `saveUserAgentRuleDocument`
