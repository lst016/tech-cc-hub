...
- `ADMIN_TOOL_NAMES@0 - 管理工具名（set_global_runtime_config）`
- `isAllowedEnvKey@0 - 验证环境变量名合法性，排除 ANTHROPIC_* 前缀`
- `normalizePatch@0 - 规范化配置补丁，应用白名单和长度限制`
- `getAdminMcpServer@0 - 获取管理 MCP 服务器`
