...
> 模块：`session-engine` · 语言：`markdown` · 行数：79
...
- `Handoff格式@0 - 包含Status/What'sDone/What'sInProgress/What'sPending/KeyDecisions/Learnings/FilesTouched/Gotchas/ResumeCommand`
