...
- `getIdeaMcpServer@50 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_TOOL_NAMES@16 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_TOOLS_SERVER_NAME@23 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_MCP_SERVER_VERSION@25 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `EDITION_SCHEMA@28 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_STATUS_SCHEMA@30 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_OPEN_SCHEMA@34 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_FOCUS_SCHEMA@43 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `IDEA_WAIT_READY_SCHEMA@45 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `statusHandler@55 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `status@62 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `recommended@63 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `openHandler@83 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `status@91 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `result@104 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
- `focusHandler@124 - mcp tool: idea_status, mcp tool: idea_open, mcp tool: idea_focus`
