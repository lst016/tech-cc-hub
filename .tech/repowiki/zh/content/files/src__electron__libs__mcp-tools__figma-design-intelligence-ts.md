...
- `buildFigmaDesignPlaybook@196 - `
- `buildFigmaDesignAudit@235 - `
- `rankDesignSystems@274 - `
- `buildRecommendedStack@285 - `
- `inferDomain@298 - `
- `normalizeFrameworks@311 - `
- `flattenNodes@322 - `
- `buildAuditStats@329 - `
- `buildAuditFindings@352 - `
- `buildTokenRecommendations@463 - `
- `buildImplementationChecklist@480 - `
- `isActionLikeNode@498 - `
- `getTextNumber@503 - `
- `formatNodeRef@508 - `
- `severityWeight@514 - `
- `clampInteger@518 - `
