...
> 模块：`pro-workflow` · 语言：`javascript` · 行数：124
...
- `getAdaptiveThreshold@0 - Calculates first/second/repeat thresholds based on correction rate: >25% correction → tight gates (3/6/6), <5% → loose (10/20/20)`
- `threshold@0 - Object with first, second, repeat values controlling when to log checkpoint and quality gate reminders`
