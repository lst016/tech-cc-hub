...
- `setCronService@25 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `buildScheduleFromInput@29 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `getCronMcpServer@96 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `CRON_TOOL_NAMES@13 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `CRON_TOOLS_SERVER_NAME@19 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `CRON_MCP_SERVER_VERSION@21 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `kind@38 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `desc@39 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `expr@43 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `seconds@53 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `ms@55 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `minutes@56 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `raw@64 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `atMs@66 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `inMinutes@68 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
- `CREATE_SCHEMA@79 - mcp tool: create_scheduled_task, mcp tool: list_scheduled_tasks, mcp tool: delete_scheduled_task`
